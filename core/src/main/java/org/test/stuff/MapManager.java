...
public class MapManager {
    ...
    private ConcurrentMap<String, String> mapTable;
    private ConcurrentMap<String, Vector2> playerStartLocationTable;
    ...
    public MapManager() {
        ...
        mapTable = new ConcurrentHashMap<>(3);
        playerStartLocationTable = new ConcurrentHashMap<>(3);
    ...
    public void loadMap(String mapName) {
        ...
        if (Utility.isAssetLoaded(mapFullPath)) {
            ...
            Gdx.app.debug(TAG, "Map " + mapFullPath + " not loaded");
            return;
        }
